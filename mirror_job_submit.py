...
IMAGE_NAME = "enlarge_negative.jpeg"
...
left_wrist_increase_factor = (left_shoulder[0] - left_wrist[0]) / (
    right_shoulder[0] - left_shoulder[0]
) + 1
print(f"left_wrist_increase_factor={left_wrist_increase_factor}")

right_wrist_increase_factor = (right_wrist[0] - right_shoulder[0]) / (
    right_shoulder[0] - left_shoulder[0]
) + 1
print(f"right_wrist_increase_factor={right_wrist_increase_factor}")

rotation_angle_radians = math.atan2(
    (right_wrist[1] - left_wrist[1]), (right_wrist[1] - left_wrist[1])
)
...
plot_lines(
    right_wrist_co=right_wrist,
    left_wrist_co=left_wrist,
    right_shoulder_co=right_shoulder,
